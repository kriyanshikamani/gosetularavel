...
@section('vendor-style')
  ...
  <link rel="stylesheet" href="{{ asset(mix('admin/vendors/css/pickers/flatpickr/flatpickr.min.css')) }}">
@endsection

@section('page-style')
 <link rel="stylesheet" href="{{ asset(mix('admin/css/base/plugins/forms/pickers/form-flat-pickr.css')) }}">
 <link rel="stylesheet" href="{{ asset(mix('admin/css/base/plugins/charts/chart-apex.css')) }}">
@endsection
...
@section('vendor-script')
  ...
  <script src="{{ asset(mix('admin/vendors/js/pickers/flatpickr/flatpickr.min.js')) }}"></script>
@endsection

@section('page-script')
  <!-- Page js files -->
  <script src="{{ asset(mix('admin/js/scripts/charts/chart-apex.js')) }}"></script>
@endsection
